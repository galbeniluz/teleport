...
- **Optional:** You can configure Machine ID to provide short-lived Teleport
  credentials to the Event Handler. Before following this guide, follow a
  Machine ID [deployment guide](../../machine-id/deployment.mdx) to run the
