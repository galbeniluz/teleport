...
- **Optional:** We recommend configuring Machine ID to provide short-lived
  Teleport credentials to the Event Handler. Before following this guide, follow
  a Machine ID [deployment guide](../../machine-id/deployment.mdx) to run the
...
<Details title='How "where" conditions work'>
...
(!docs/pages/includes/plugins/tbot-identity.mdx!)
</TabItem>
...
<Details title="Overriding annotation names">
