...
`teleportVersionOverride` controls the Teleport Kubernetes Opertator
...
The user is responsible for creating the `PritotityClass` resource before deploying the chart.
