...
typically used with [MachineID](../machine-id/introduction.mdx) to access
Teleport-protected resources in GitHub Actions pipelines.

(!docs/pages/includes/provision-token/github-spec.mdx!)

<Admonition type="note" title="See Also">
- [Deploying Machine ID on GitHub Actions](../machine-id/deployment/github-actions.mdx)
</Admonition>

### CircleCI: `circleci`

This join method is typically used with [MachineID](../machine-id/introduction.mdx)
to access Teleport-protected resources in Circle CI pipelines.

(!docs/pages/includes/provision-token/circleci-spec.mdx!)

<Admonition type="note" title="See Also">
- [Deploying Machine ID on Circle CI](../machine-id/deployment/circleci.mdx)
</Admonition>
...
<Admonition type="note" title="See Also">
- [Deploying Machine ID on GitLab CI](../machine-id/deployment/gitlab.mdx)
</Admonition>
...
`spec.kuebrnetes.static_jwks.jwks` field).
</Admonition>
